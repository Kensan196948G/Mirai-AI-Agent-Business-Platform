 ...
 * 助詞・記号・1 文字の断片は捨てる。
 */
// 建設系の出典ではほぼ全文書に現れ、検索の弁別に役立たない語（評価ランナーの TC-02 で「存在」が本文一致した事象から拡充）
const STOP = new Set([
  'こと', 'もの', 'ため', 'これ', 'それ', 'あれ', 'よう', 'とき', 'ところ', 'について', 'ください', 'です', 'ます', 'する', 'した', 'して', 'ある', 'いる', 'なる', 'できる', 'おり', 'また', 'および',
  '場合', '条件', '実績', '技術', '工事', '提案', '論点', '適用', '教えて', '検討', '比較', '整理', '確認',
  '存在', '可能', '必要', '利用', '使用', '対応', '実施', '施工', '管理', '効果', '向上', '削減', '低減', '程度', '以上', '以下', '以内', '範囲', '方法', '作業', '現場',
  '情報', '資料', '記載', '公開', '概要', '課題', '目的', '用途', '特徴', '当社', '弊社', '本技術', '本工事', '一般', '各種', '全体', '部分', '状況', '内容', '結果',
]);
